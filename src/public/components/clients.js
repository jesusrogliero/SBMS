...
// componente clients
let clients = Vue.component('clients', {
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? 'Nuevo Cliente' : 'Actualizar un Cliente';
    },
  },
  ...
  methods: {
    ...
    editItem: async function(item) {
      ...
      this.editedItem = await execute('show-client', this.editedIndex);
      this.dialog = true
    },
    ...
    deleteItemConfirm: async function() {
      let result = await execute('destroy-client', this.editedIndex);
    ...
    save: async function() {
      ...
      if (this.editedIndex > -1) {
        result = await execute('update-client', this.editedItem);
      } else {
        result = await execute('create-client', this.editedItem);
      }
